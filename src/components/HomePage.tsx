        ...
        <div className="p-4 sm:p-8 h-full" style={{ backgroundColor: 'var(--color-surface)', borderRadius: '0.75rem', border: '1px solid var(--color-border)', boxShadow: '0 1px 2px 0 rgb(0 0 0 / 0.05)' }}>
            ...
            <div className="mt-12 text-center p-6 rounded-lg" style={{ backgroundColor: 'var(--color-background)' }}>
                {isDesktop ? (
                    ...
                    <button 
                        onClick={onStart} 
                        className="w-full sm:w-auto bg-blue-600 text-white font-bold py-3 px-8 rounded-md hover:bg-blue-700 transition-all duration-300 flex items-center justify-center text-base shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/40 focus:outline-none focus:ring-4 focus:ring-blue-500 focus:ring-opacity-50"
                    >
                        Create New Paper
                    </button>
                )}
